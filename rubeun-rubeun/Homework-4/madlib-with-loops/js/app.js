...
const startupX = ['Uber', 'Google', 'Amazon', 'Apple', 'Facebook', 'Twitter', 'AirBnB', 'Tinder', 'Netflix', 'PayPal'];
const startupY = ['Slack', 'Trello', 'Tesla', 'Hyperloop', 'Harvest', 'Instagram', 'Yelp', 'LinkedIn'];
